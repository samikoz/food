...
\item{sugar, 0.8}
\item{yolks, 5}
\item{all-purpose flour, 500-550, 2/3}
\item{milk, 2}
\item{butter, 1 Tb}
...
\comment{For about 2.5 cups, originally 1 cup sugar. Might thicken significantly as it cools; observe. When ready to serve mechanically beat until smooth and glossy.}

\comment{For crème Saint--Honoré beat 8 egg whites and gradually fold in.}

\comment{Compare with cornstartch instead of flour, 3 Tb for 2 milk or 2--4 times less.}
