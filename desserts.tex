...
\comment{Faktycznie w sumie 1:4. Ottolenghi dodaje tłuste po pierwszym podgotowaniu.}
...
\recipara{Zblenduj wszystko, naczynie natrzyj masłem, zalej cienko i wstaw na otwarty ogień na 1--2 by zrobić warstewkę ściętego ciasta na dole. Teraz reszta owoców i reszta ciasta. Piecz aż brzegi zaczną się rumienić, w środku będzie bledsze, 30--40. Koniecznie do odstygnięcia 15--20, będzie się jeszcze ścinać. Serwować na ciepło, nie gorąco.}

\commentskip

\recipara{Dotąd mleko:jaja:mąka:cukier 1:3:0.5:0.25, duże jaja, piekłem 15. Zbyt mączno-jajeczne. Wszyscy pieką 30--40 w 180. Julia 1.25:3:0.66 i piecze przez godzinę na środku! Gdzie indziej zobaczyłem ją z 0.5 mąki -- pojedź z tym. Generalnie patrz na kolor, chcemy bardziej blade niż żółte; nie dodawaj cynamonu, nie zaciemniaj obrazu.}
\comment{Inny ziomuś robi 2 jajka + żółtko na 200 mleka + 100 śmietany i tylko kopiastą łyżkę mąki. Ale śmietana robi dużą różnicę myślę.}
\comment{Płyn można aromatyzować gotując z ziołami; palone masło; owoce można namaczać w alkoholu zamiast równej ilości mleka; wanilia raczej konieczna jednak.}
\comment{W wąskim naczyniu będzie trudniej o porządaną konsystencję, brzegi zawsze się zetną.}
