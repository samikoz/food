...
\section{White wine poached fish in white sauce}

\begin{ingreds}
\item{salmon, cod, halibut, trout, sole entier}
\item{shallots, green onions}
\item{butter}
\item{white wine}
\end{ingreds}

\recipara{Fillet the fish and make the fish stock with white wine -- cup per half kilo, water to cover. Cool down.} 
\recipara{Preheat the oven. Dice the onions and place half in a buttered dish. Then the fish, salt, pepper, the rest of onions, small bits of butter. Pour the liquid to barely cover. Bring to simmer. Lay buttered brown paper over the dish and place in the bottom of the oven. Keep the liquid barely simmering for 8 -- 12 min. Fork should pierce the flesh easily, should be delicate and not flaky, dry or stiff.}
\recipara{Take out the fish and use the liquid as a base for white sauce. It should be more runny than thick.}

\commentskip

\comment{Serve with boiled potatoes. The salad and veggies should come after, not to disturb the fish with the wine.}
\comment{If cannot bring the oven dish to simmer on a stove, preheat it in the oven. Then toss the onions, fish and liquid.}
