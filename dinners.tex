...
\section{Omlet z czerwonej soczewicy}

\begin{ingreds}
\item{czerwona soczewica, 0.3 szklanki lub fasola mung luib mąka z cieciorki}
\opitem{mąka z tapioki, skrobia ziemniaczana, coś innego, 2.5 łyżki}
\item{cebula, 0.5}
\opitem{warzywa, grzyby}
\opitem{świeża pietruszka, szczypiorek}
\opitem{czosnek w proszku}
\opitem{pieprz}
\opitem{kmin rzymski}
\opitem{wędzona papryka}
\item{czarna sól, kala namak}
\item{turmeric}
\end{ingreds}

\recipara{Warszywa podsmażyć.}
\recipara{Czerwoną soczewicę zmielić w blenderze do kawy. Jeśli używamy fasoli mung, namoczyć do dwóch godzin, odcedzić, osuszyć, zmielić. Jeśli nie mamy, dać o jedną trzecią więcej soczewicy.}
\recipara{Połączyć suche składniki w misce. Dodać tyle kala namak żeby był wyczuwalny smak jajka i tyle turmericu żeby zabarwił. Dodać dwie trzecie szklanki wody, trochę więcej jeśli robimy moongleta. Wymieszać z ziołami i podsmażonymi warzywami. Można smażyć bez tłuszczu na dobrej patelni.}
...
\begin{ingreds}
\item{mąka, 3 szklanki}
\item{olej, 3 łyżki}
\item{sól, płaska łyżeczka}
\item{szklanka wody, przestudzona 3--4 minuty z wrzenia}
\end{ingreds}

\recipara{Wymieszać mąkę, olej, sól i wodę. W misce zgarniać od dołu i przyciskać bicepsem. Uformować w kulę i rzucić na przyprószoną mąką stolnicę. Zaginać tj. silnie rolować do przodu, zawijać do tyłu w calzone, łączyć boki z powrotem do kuloidy. Ciasto nie może być zbyt lepkie, musi być gładkie. Rozporcjować obmączonym nożem, zostawić do odpoczynku, pod wilgotną ściereczką żeby się nie zasuszyło.}
\recipara{Cienko rozwałkować wałkiem oprószonym mąką, na również przyprószonym blacie; prędko żeby ciasto nie schło. Szklankami odmierzać koła. Pierogi lepić mokrymi palcami. Do środka włożyć farsz, zagiąć w naleśnik, zrobić falbanki - domykać kciukiem i palcem wskazującym, potem przejechać poprzecznie paznokciem. Kłaść na przyprószoną mąką powierzchnię.}

\subsection{ruskie}\vspace{-1em}
\begin{ingreds}
\item{ugotowane ziemniaki, 0.5kg}
\item{twaróg tłusty, 250g}
\item{przysmażona cebula, 1}
\item{pieprz}
\end{ingreds}

\subsection{z kaszą gryczaną}\vspace{-1em}
\begin{ingreds}
\item{kasza gryczana, 100g nieugotowanej}
\item{twaróg tłusty, 250g}
\item{przysmażona cebula, 1.5}
\item{średnie jajko (żeby był bardziej zwarty)}
\opitem{musztarda 1 łyżeczka}
\opitem{mięta albo szałwia}
\end{ingreds}

\commentskip

\comment{Małgorzata nie daje oleju, babcia Sternika daje jajko. Krótko wyrabiać na kopczyku bo ciasto twardnieje.}
\comment{Około 50 sztuk.}
\comment{Ten z kaszą gryczaną spróbuj zmodyfikować, żeby nie miał twarogu.}
\comment{Farsz powinien być dobrze doprawiony. Będzie mniej wyrazisty po ugotowaniu.}
\comment{Jeśli podajemy na drugi dzień to ugotować i włożyć do lodówki. Można polać olejem by się nie sklejały, chociaż gotowane nie powinny. Jeśli do zamrożenia to ulepione zanurzyć w osolonym wrzątku na 30s, ułożyć w odstępach na natłuszczonej olejem tacy. Do zamrażarki na 2 godziny, potem szczelnie zamknąć w woreczkach foliowych. Jeść natychmiast po ugotowaniu -- na wigilię zrób coś, co będzie dobre później, odgrzewane.}
